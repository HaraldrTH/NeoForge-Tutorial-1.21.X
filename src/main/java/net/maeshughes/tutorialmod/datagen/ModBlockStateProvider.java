package net.maeshughes.tutorialmod.datagen;

import net.maeshughes.tutorialmod.TutorialMod;
import net.maeshughes.tutorialmod.block.ModBlocks;
...
public class ModBlockStateProvider extends BlockStateProvider {
    ...
    private void customLamp(){
        getVariantBuilder(ModBlocks.BISMUTH_LAMP.get()).forAllStates(state -> {
            if (state.getValue(BismuthLampBlock.CLICKED)) { //When lamp is clicked, return on-texture. Otherwise, return off-texture
                return new ConfiguredModel[]{new ConfiguredModel(models().cubeAll("bismuth_lam_on",
